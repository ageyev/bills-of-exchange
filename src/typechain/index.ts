...
export type { BillsOfExchange } from "./src/contracts/BillsOfExchange";
export { BillsOfExchange__factory } from "./factories/src/contracts/BillsOfExchange__factory";
export type { Lock } from "./src/contracts/Lock";
export { Lock__factory } from "./factories/src/contracts/Lock__factory";
